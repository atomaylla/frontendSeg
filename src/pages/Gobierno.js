        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Gobierno" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                    ...
                    <Dialog visible={deleteProductDialog} style={{ width: '450px' }} header="Confirmación" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {aplicacion && <span> Deseas  eliminar el gobierno  <b>{aplicacion.nombre}</b>?</span>}
                        </div>
                    </Dialog>
...
export default React.memo(Gobierno, comparisonFn);
